...
applyT :: forall m x. (MonadIO m)
    => N1 -> T_ -> (forall a. (Rec a) => (a -> m x)) -> m x
applyT x rec f = case x of
    0x01 -> apply recOf rec (f :: T_CGCSGI -> m x)
    0x02 -> apply recOf rec (f :: T_FQN -> m x)
    0x04 -> apply recOf rec (f :: T_MO -> m x)
    0x10 -> apply recOf rec (f :: T_OCL -> m x)
    0x18 -> apply recOf rec (f :: T_MIS -> m x)
    0x1D -> apply recOf rec (f :: T_TO -> m x)
    0x1F -> apply recOf rec (f :: T_FDS -> m x)
    0x20 -> apply recOf rec (f :: T_FCGCSGI -> m x)
    0x21 -> apply recOf rec (f :: T_OFSS -> m x)
    0x22 -> apply recOf rec (f :: T_ROT -> m x)
    0x23 -> apply recOf rec (f :: T_ERLI -> m x)
    0x24 -> apply recOf rec (f :: T_RLI -> m x)
    0x25 -> apply recOf rec (f :: T_RSN -> m x)
    0x26 -> apply recOf rec (f :: T_CR -> m x)
    0x27 -> apply recOf rec (f :: T_LDOPM -> m x)
    0x2D -> apply recOf rec (f :: T_OBO -> m x)
    0x36 -> apply recOf rec (f :: T_AV -> m x)
    0x43 -> apply recOf rec (f :: T_DP -> m x)
    0x45 -> apply recOf rec (f :: T_MEC -> m x)
    0x46 -> apply recOf rec (f :: T_POCP -> m x)
    0x47 -> apply recOf rec (f :: T_RUA -> m x)
    0x4B -> apply recOf rec (f :: T_OAMU -> m x)
    0x4C -> apply recOf rec (f :: T_OAS -> m x)
    0x4D -> apply recOf rec (f :: T_AD -> m x)
    0x4E -> apply recOf rec (f :: T_CS -> m x)
    0x50 -> apply recOf rec (f :: T_ESI -> m x)
    0x56 -> apply recOf rec (f :: T_MMPN -> m x)
    0x57 -> apply recOf rec (f :: T_OBE -> m x)
    0x58 -> apply recOf rec (f :: T_OSFO -> m x)
    0x59 -> apply recOf rec (f :: T_OSFE -> m x)
    0x5A -> apply recOf rec (f :: T_OO -> m x)
    0x5D -> apply recOf rec (f :: T_FHSF -> m x)
    0x5E -> apply recOf rec (f :: T_OCO -> m x)
    0x62 -> apply recOf rec (f :: T_LDTS -> m x)
    0x63 -> apply recOf rec (f :: T_T2FRMT -> m x)
    0x64 -> apply recOf rec (f :: T_OOI -> m x)
    0x65 -> apply recOf rec (f :: T_C -> m x)
    0x68 -> apply recOf rec (f :: T_MOR -> m x)
    0x6C -> apply recOf rec (f :: T_ROI -> m x)
    0x6D -> apply recOf rec (f :: T_EF -> m x)
    0x70 -> apply recOf rec (f :: T_PSRM -> m x)
    0x71 -> apply recOf rec (f :: T_PSMR -> m x)
    0x72 -> apply recOf rec (f :: T_UDTS -> m x)
    0x73 -> apply recOf rec (f :: T_II -> m x)
    0x74 -> apply recOf rec (f :: T_TS -> m x)
    0x75 -> apply recOf rec (f :: T_CF -> m x)
    0x78 -> apply recOf rec (f :: T_FF -> m x)
    0x79 -> apply recOf rec (f :: T_MA -> m x)
    0x80 -> apply recOf rec (f :: T_AQ -> m x)
    0x81 -> apply recOf rec (f :: T_PPI -> m x)
    0x82 -> apply recOf rec (f :: T_PV -> m x)
    0x83 -> apply recOf rec (f :: T_PC -> m x)
    0x84 -> apply recOf rec (f :: T_FRMT -> m x)
    0x85 -> apply recOf rec (f :: T_FO -> m x)
    0x87 -> apply recOf rec (f :: T_MF -> m x)
